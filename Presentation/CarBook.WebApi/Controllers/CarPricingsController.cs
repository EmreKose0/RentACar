...
namespace CarBook.WebApi.Controllers
{
    ...
    public class CarPricingsController : ControllerBase
    {
        ...
        {
            var values = await _mediator.Send(new GetCarPricingWithCarQuery());  //GetCarPricingWithCarQuery e istek atıcaz, IRequestHandler ksımında kullanmıstık GetFaatureQuery yi
            return Ok(values);
        }
